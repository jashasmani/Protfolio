        ...
        <div className="content">
          ...
          <div>
            ...
            <p className="about-text">
              ...
              technologies such as React, Node.js, and Material-UI, I
              continually strive to stay at the forefront of industry trends.
              Each project is an opportunity to innovate and bring ideas to
              life. Explore my portfolio to see how I transform concepts into
              interactive solutions that enhance user engagement and
              satisfaction.
            </p>
          </div>
        </div>
